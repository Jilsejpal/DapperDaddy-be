...
exports.createProduct = catchAsyncErrors(async (req, res, next) => {
    ...
    for (let i = 0; i < banner.length; i++) {
        const result = await cloudinary.v2.uploader.upload(banner[i], {
            folder: "products",
        });
    ...
    for (let i = 0; i < banners.length; i++) {
        const result = await cloudinary.v2.uploader.upload(banners[i], {
            folder: "products",
        });
...
// get Product by id
exports.getProductDetails = catchAsyncErrors(async (req, res, next, id) => {
